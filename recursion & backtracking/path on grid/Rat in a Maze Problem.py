...
class Solution:
    ...
    def dfs(self,r,c,path):
        ...
        for ch,dr,dc in self.dirs:
            nr,nc=r+dr,c+dc
            if self.inside(nr,nc) and not self.visited[nr][nc] and self.maze[nr][nc]==1:
                self.dfs(nr,nc,path+ch)
    ...
    def ratInMaze(self, maze):
        ...
        if self.n==0 or maze[0][0]==0 or maze[self.n-1][self.n-1]==0:
            return []
        ...
        self.dirs=[('D',1,0),('L',0,-1),('R',0,1),('U',-1,0)]
