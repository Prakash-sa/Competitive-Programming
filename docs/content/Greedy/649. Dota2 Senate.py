...
# The condition while (rCount && dCount) will be executed O(N) times because they are the simulation of the voting process, which is bounded by O(N) as discussed in Overview section.
